...
<html lang="en">
   ...
   <div class="navigation">
      ...
      <div class="middlediv">
         <div class="innerdiv">
            <div class="maindiv">
               <h2 class="headingstyle"> Sample Heading  </h2>
               <p class="paragraphstyle">Lorem Ipsum is simply dummy text of the printing and typesetting industry. 
                  Lorem Ipsum has been the industry's <span class="innerpara">standard dummy text ever since the 1500s, 
